...
public class TestDepartment {
	...
	public static void main(String[] args) {
		...
		// create 4 students
		Student murat = new Student("MURAT", "04654", "Fall", 2009);
		Student deniz = new Student("DENIZ", "04914", "Spring", 1998);
		Student aysenur = new Student("AYSENUR", "04002", "Summer", 2015);
		Student songur = new Student("SONGUR", "04999", "Fall", 2013);
